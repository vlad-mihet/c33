 ...
 */
function generateSampleXlsx(): void {
  console.warn('📊 Generating sample XLSX file...');

  const sampleData = [
    {
      name: 'Charles Babbage',
      email: 'charles.babbage@c33.io',
      balance: 25000,
    },
    {
      name: 'Tim Berners-Lee',
      email: 'tim.berners-lee@c33.io',
      balance: 30000,
    },
    ...
    { name: 'Dennis Ritchie', email: 'dennis.ritchie@c33.io', balance: 18500 },
    {
      ...
      email: 'bjarne.stroustrup@c33.io',
      balance: 16000,
    },
    {
      name: 'Guido van Rossum',
      email: 'guido.vanrossum@c33.io',
      balance: 19500,
    },
  ...
  console.warn(`✅ Sample XLSX file created: ${filePath}`);
  console.warn(
    `📝 Contains ${String(sampleData.length)} sample customer records`,
  );
}
